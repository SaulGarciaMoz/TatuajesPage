    ...
    <div className='AllPage'>
      ...
      >
        ...
        <div className={Style.container}>
          <h1>Administrador</h1>
          <Link href="/AdminCitas" passHref>
            <button className={Style.button}>Citas</button>
          </Link>
          <Link href="/VerClientes" passHref>
            <button className={Style.button}>Clientes</button>
          </Link>
          <Link href="/VerTrabajadores" passHref>
            <button className={Style.button}>Trabajadores</button>
          </Link>
        </div>
